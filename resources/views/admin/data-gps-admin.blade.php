...
@section('title', 'Manage Gps Admin')
...
<div class="container" ng-controller="adminController">
        ...
        <div class="col-md-6 col-md-offset-3" >
            <div class="panel-group">
                 <div class="panel panel-primary animated" id="gpsAdd" ng-show="showFormAdd">
            ...
            <div class="panel panel-success animated" id="gpsUpdate" ng-show="showFormUpdate">
...
<script type="text/javascript">
    ...
    // Setup Controller
    angular.module('app').controller('adminController', ($scope, $http) => {
        ...
        // Show Form Add Gps
        $scope.showAddForm = () => {
            $("#gpsAdd").addClass("bounceInLeft", () => {
                $scope.showFormUpdate = false;
                $scope.showFormAdd = true
            });

            setTimeout(function() {
                $("#gpsAdd").removeClass("bounceInLeft");
            }, 1000);
        ...
        $scope.showUpdateForm = id => {
            ...
            $("#gpsUpdate").addClass("bounceInRight", () => {
               $scope.showFormAdd = false;
        ...
        $scope.getData = () => {
            // Get Data with AJAX
            $http.get('/admin/getDataGps').then( response => {
        ...
        $scope.deleteDataGps = id => {
            ...
            swal({
              ...
              if (result.value) {
                ...
                $http({
                    method  : 'DELETE',
                    url     : '/admin/deleteDataGps/' + data.id
                }).then(() => {
